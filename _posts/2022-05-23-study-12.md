...
# 면들 사이의 거리 계산
d100=a/math.sqrt(l1**2 + m1**2 + n1**2);     #spacing between (100) plane
d110=a/math.sqrt(l2**2 + m2**2 + n2**2);     #spacing between (110) plane
d111=a/math.sqrt(l3**2 + m3**2 + n3**2);     #spacing between (111) plane
